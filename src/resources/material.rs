use crate::{commons::{damage_model::DamageComponent, resource_map::ResourceMap}, engine::Color};
...
pub(crate) struct Material {
    ...
    pub(crate) extra_damage: DamageComponent,
}
...
impl Material {
    ...
    pub(crate) fn new_metal(name: &str) -> Material {
        Material {
            ...
            extra_damage: DamageComponent::arcane(0.),
        }
    }
